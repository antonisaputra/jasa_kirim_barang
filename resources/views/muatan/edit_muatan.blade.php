    ...
    <div class="card">
        ...
        <form action="/edit_muatan/{{$muatan->id}}" method="post">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="mb-3 me-3">
                        <label for="no_kendaraan" class="form-label">Truck No Polisi</label>
                        <input type="text" class="form-control" id="no_kendaraan" name="no_kendaraan" value="{{$muatan->no_kendaraan}}">
                        @error('no_kendaraan')
